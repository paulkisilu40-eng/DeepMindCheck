...
class UserFeedback(models.Model):
    ...
    correct_label = models.CharField(max_length=20, null=True, blank=True, help_text="User suggested correct label if prediction was wrong")
